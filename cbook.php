        ...
        <div class="row">
          <div class="container">
            <div class="text-center">
                <a href="abuku.php"><button class="btn btn-outline-primary">Masukkan 1 Buku</button></a>
                &nbsp; &nbsp; &nbsp; &nbsp;
                <a href="add.php"><button class="btn btn-outline-primary">Masukkan Banyak Buku</button></a>
            </div>
